# Если ты попавс на их ваку с тестовым, то это послание для тебя.

SGS VOSTOK LIMITED КРЫСИНАЯ КОНТОРА ПИДАРАСОВ. Ноль фидбека, просто молчат, нихуя до сих пор. явахуи.

Кстати, сначала пизда-рекрутер их скинула внутренний линк для ххрю-рекрутеров на тестовое, я ей об этом указал и только на след день она(они, хз, чо там у них, долбоебов некомпетентных, творится), так и не поняв, как сделать как нада, переслала тестовое тупа текстом.
